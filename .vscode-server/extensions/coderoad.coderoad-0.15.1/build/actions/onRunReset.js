...
const onRunReset = async (action, context) => {
    ...
    const hash = (0, lastHash_1.default)(position, tutorial);
    ...
    (0, reset_1.default)({ branch, hash });
    const resetActions = (_a = tutorial === null || tutorial === void 0 ? void 0 : tutorial.config) === null || _a === void 0 ? void 0 : _a.reset;
    if (resetActions) {
        hooks.onReset({ commands: resetActions === null || resetActions === void 0 ? void 0 : resetActions.commands, vscodeCommands: resetActions === null || resetActions === void 0 ? void 0 : resetActions.vscodeCommands }, tutorial === null || tutorial === void 0 ? void 0 : tutorial.id);
    }
};
