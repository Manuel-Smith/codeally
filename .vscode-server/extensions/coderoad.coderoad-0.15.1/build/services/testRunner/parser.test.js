...
ok 1 - Should pass
`;
            expect((0, parser_1.default)(example)).toEqual({
                ok: true,
...
`;
            const result = (0, parser_1.default)(example);
...
`;
            expect((0, parser_1.default)(example).ok).toBe(false);
        });
...
`;
            expect((0, parser_1.default)(example).failed).toEqual([{ message: 'First to fail' }, { message: 'Second to fail' }]);
        });
...
# skip 0
`;
            expect((0, parser_1.default)(example).ok).toBe(true);
        });
...
# skip 0
`;
            expect((0, parser_1.default)(example).failed).toEqual([{ message: "sumItems shouldn't return NaN" }]);
        });
